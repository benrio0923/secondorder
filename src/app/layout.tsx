...
import './globals.css'
import { SessionProvider } from '@/lib/so/session'

export const metadata: Metadata = {
  title: '第二单 — 贵州白酒出海首单决策副驾',
  description:
    '扫码验茅台真假大家都会，这次扫的不是酒，是买家。判断他是真想卖酒还是在做税差，算出这瓶酒到他货架上要卖多少钱，告诉你合同该写死哪几条。',
}
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="zh-Hans">
      ...
      <body className="field bg-paper text-ink antialiased">
        <div className="above">
