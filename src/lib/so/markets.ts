...
const SRC =
  '美国三层制公开数据：进口商／供应商毛利率约 50–55%，批发商 20–40%（新品牌 30–35%），零售加价 25–30%（约当毛利率 20–23%），餐饮端毛利率 75–85%。非美市场以此结构推估，实际依当地渠道层级调整。'
    ...
    licences: [
      {
        ...
        ifMissing: '你的渠道建立在别人的牌照上——牌照一旦出事，你的货连同市场一起没了。',
      },
      {
        who: 'you',
        name: '标签审核＋成分备案',
  ...
  us: {
    ...
    licences: [
      ...
      },
      {
        ...
        name: '酒标核准证 COLA',
        detail:
          '表格 5100.31，逐款申请。标签须含酒精度、净含量、生产商信息与健康警语。',
        form: 'TTB F 5100.31',
        source: '美国酒精烟草税务贸易局 TTB',
