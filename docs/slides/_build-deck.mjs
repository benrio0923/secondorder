...
// ── 主视觉 12 页：整页图 + 讲稿写进备注 ──
const NOTES = {
 s01:'（0:00–0:20）开场，指着大标题。\n「扫码验茅台真假，大家都会。这次扫的不是酒，是买家。」停一拍。\n我们做的是贵州白酒出海的首单决策副驾。',
 s02:'（0:20–0:55）遵义综保区 2025 年工作总结的一组罕见诚实数字。\n89 家完成出口备案，35 家有意向，11 家真的出了海，最后 5 家「建立初步联系」。转化率 5.6%。\n注意最后一级的措辞——是「建立初步联系」，不是签约，更不是复购。公开资料在这里就断了。',
 s03:'（0:55–1:20）中小酒企没有海外团队。展会散场，手上十几张名片，他真正的问题只有三个，而市面上的工具一个都没答。',
 s04:'（1:20–1:50）这是最关键的一页。\n套利型买家要的从来不是这瓶酒，是那 33%——消费税 20% 从价出口免征，加增值税退税 13%。\n他把货囤进自贸仓，转手就走，酒根本没上过货架。',
 s05:'（1:50–2:15）判断错了代价多少：一柜货值 261 万，卖不掉折价倒回国内亏 78 万。\n更贵的是当地价格体系被打乱，之后没有第二个经销商愿意接。',
 s06:'（2:15–2:40）产品登场。贴一段微信对话进去，八秒出一份决策简报。\n模型只做一件事——把这段话读成结构。判定不归它管。',
 s07:'（2:40–3:05）我们的判定用一瓶酒表示。\n瓶子永远是满的，变的是里面装什么。琥珀是酒，红色是税差，从瓶底把酒顶上来。',
 s08:'（3:05–3:30）六个页签，一页回答一个问题。业务员站在展位上，需要的是六个答案，不是一篇文章。\n（现场 demo 就走这六页）',
 s09:'（3:30–4:00）三个通用大模型不会告诉你的细节，全是我们翻税则翻出来的：\n香港减税只减 200 港币以上那部分；新加坡按纯酒精量收，降度数等于直接少缴税；\n美国 CBMA 额度必须由中国生产商主动指派，进口商自己拿不到——约 10.7 元一瓶，一柜十几万，不花你一毛钱。',
 s10:'（4:00–4:25）技术主张：规则算账，模型说人话。\n税则、牌照、条款、去留判定全是可审计的纯函数，每条带来源与生效日期。模型只负责读懂对话和写成人话。\n模型挂了主链路照样跑完——现场断网也能演示。',
 s11:'（4:25–4:45）一百天怎么落地。第三步是设计来证伪自己的：拿报关单回来验落地价，误差超过 20% 就得重做税则模型。',
